...
namespace FSH.Starter.Blazor.Infrastructure.Api
{
    ...
    public partial interface IApiClient
    {
        ...
        System.Threading.Tasks.Task<CreateAssetResponse> AddAssetEndpointAsync(string version, CreateAssetCommand body);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateAssetResponse> AddAssetEndpointAsync(string version, CreateAssetCommand body, System.Threading.CancellationToken cancellationToken);

        /// <summary>
        /// Get a list of assets
        /// </summary>
        /// <remarks>
        /// Get a list of assets with pagination and filtering support
        /// </remarks>
        /// <param name="version">The requested API version</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<AssetResponsePagedList> SearchAssetEndpointAsync(string version, SearchAssetsCommand body);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<AssetResponsePagedList> SearchAssetEndpointAsync(string version, SearchAssetsCommand body, System.Threading.CancellationToken cancellationToken);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<CreateAssetResponse> AddAssetEndpointAsync(string version, CreateAssetCommand body)
        {
            return AddAssetEndpointAsync(version, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<CreateAssetResponse> AddAssetEndpointAsync(string version, CreateAssetCommand body, System.Threading.CancellationToken cancellationToken)
        {
            if (version == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/v{version}/portfolio/assets"
                    ...
                    urlBuilder_.Append("/portfolio/assets");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<AssetResponsePagedList> SearchAssetEndpointAsync(string version, SearchAssetsCommand body)
        {
            return SearchAssetEndpointAsync(version, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<AssetResponsePagedList> SearchAssetEndpointAsync(string version, SearchAssetsCommand body, System.Threading.CancellationToken cancellationToken)
        {
            if (version == null)
                throw new System.ArgumentNullException("version");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/v{version}/portfolio/assets/search"
                    urlBuilder_.Append("api/v");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(version, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/portfolio/assets/search");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<AssetResponsePagedList>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AssetResponsePagedList
    {

        [System.Text.Json.Serialization.JsonPropertyName("items")]
        public System.Collections.Generic.ICollection<AssetResponse>? Items { get; set; } = default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CreateAssetCommand
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SearchAssetsCommand
    {
